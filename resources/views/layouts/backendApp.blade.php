                            ...
                            <ul class="sidebar-menu">
                                ...
                                <li class="sidebar-menu-item">
                                    ...
                                    <ul class="sidebar-submenu collapse" id="usermanagement">
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button"
                                                href="{{ route('dashboard.role-pemission.index') }}">
                                        ...
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button"
                                                href="{{ route('dashboard.role-pemission.create') }}">
                                        ...
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button"
                                                href="{{ route('dashboard.role-assign.index') }}">
                                        ...
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button"
                                                ...
                                                <span class="sidebar-menu-text">User Show</span>
                                            </a>
                                        </li>
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" data-toggle="collapse" href="#apps_menu">
                                        <i
                                            class="sidebar-menu-icon sidebar-menu-icon--left material-icons">slideshow</i>
                                        <span class="sidebar-menu-text">Patient Management</span>
                                        <span class="ml-auto sidebar-menu-toggle-icon"></span>
                                    </a>
                                    <ul class="sidebar-submenu collapse" id="apps_menu">
                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button" href="{{ route('patient') }}">
                                                <span class="sidebar-menu-text">Patiend Registration</span>
                                            </a>
                                        </li>

                                        <li class="sidebar-menu-item">
                                            <a class="sidebar-menu-button" href="app-activities.html">
                                                <span class="sidebar-menu-text">Patiend Room</span>
                                            </a>
                                        </li>
